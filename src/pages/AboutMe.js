...
function AboutMe() {
  return (
    <div className='about-me'>
        <h1>About Me</h1>
        <p>
          Hello! I'm a recent graduate from the University of Wisconsin - Madison, currently pursuing my Master's in Computer Science and Engineering at the University of California - San Diego. 
          I’m an enthusiastic tech savvy who is inspired by the rapid growth of modern-day technology. 
          In particular, I'm intrigued by the variety of services offered by various cloud providers with my passion lying in cloud infrastructure.
        </p>
        <p>
